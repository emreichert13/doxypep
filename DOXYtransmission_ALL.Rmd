...
#pdf(paste0(filepath, "DOXYPEP_PrevALL.pdf"), height = 6, width = 8)
prev <- ggplot() +
...
prev
#dev.off()
#ggsave(file = paste0(filepath, "DOXYPEP_PrevALL.svg"), plot = prev, height = 6, width = 8)
...
#pdf(paste0(filepath, "DOXYPEP_PR_ALL.pdf"), height = 3, width = 3)
PR <- ggplot() +
...
PR
#dev.off()
#ggsave(file = paste0(filepath, "DOXYPEP_PR_ALL.svg"), plot = PR, height = 3, width = 3)
