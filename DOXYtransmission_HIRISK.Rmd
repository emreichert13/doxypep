...
#pdf("~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_PrevHI.pdf", height = 6, width = 8)
prevHI <- ggplot() +
...
prevHI
#dev.off()
#ggsave(file = "~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_PrevHI.svg", plot = prevHI, height = 6, width = 8)

# pdf("~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_IncHI.pdf", height = 6, width = 8)
# ggplot() +
...
#pdf("~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_PRHI.pdf", height = 3, width = 3)
PRHI <- ggplot() +
...
PRHI
#dev.off()
#ggsave(file = "~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_PRHI.svg", plot = PRHI, height = 3, width = 3)

# #pdf("~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_IRRHI.pdf", height = 3, width = 3)
# ggplot() +
...
#pdf("~/Documents/2021 Grad lab research/DOXYPEP/ResistProfileHI.pdf", width = 6, height = 5)
