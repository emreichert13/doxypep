...
prev_HI
#dev.off()
#ggsave(file = paste0(filepath, "DOXYPEP_PrevHI.svg"), plot = prev_HI, height = 6, width = 8)
...
PR_HI
#dev.off()
#ggsave(file = paste0(filepath, "DOXYPEP_PRHI.svg"), plot = PR_HI, height = 3, width = 3)
...
ggplot(infectiondat,aes(x=time/365, y=percent*100, fill = factor(ResistLabels, levels = c("Neither", "High-level\nTetracycline only", "Ceftriaxone\nonly", "Dual")))) +
