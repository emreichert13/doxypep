...
#pdf("~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_Prev.pdf", height = 6, width = 8)
prev <- ggplot() +
...
prev
#dev.off()
#ggsave(file = "~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_Prev.svg", plot = prev, width = 8, height = 6)

#pdf("~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_Inc.pdf", height = 6, width = 8)
inc <- ggplot() +
...
inc
#dev.off()
#ggsave(file = "~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_Inc.svg", plot = inc, width = 8, height = 6)
```
...
#pdf("~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_PR.pdf", height = 3, width = 3)
PR <- ggplot() +
...
PR
#dev.off()
#ggsave(file = "~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_PR.svg", plot = PR, width = 3, height = 3)

#pdf("~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_IRR.pdf", height = 3, width = 3)
IRR <- ggplot() +
...
IRR
#dev.off()
#ggsave(file = "~/Documents/2021 Grad lab research/DOXYPEP/DOXYPEP_IRR.svg", plot = IRR, width = 3, height = 3)
```
...
#pdf("~/Documents/2021 Grad lab research/DOXYPEP/ResistProfile.pdf", width = 6, height = 5)
...
ggplot(infectiondat,aes(x=time/365, y=percent*100, fill = factor(ResistLabels, levels = c("Neither", "Doxycycline only", "Ceftriaxone only", "Ceftriaxone and\nDoxycycline")))) +
  ...
  theme(legend.position = c(0.87,0.2), plot.subtitle = element_text(hjust = 0.5)) +
